...
function normalizeAdminAccess(value: unknown): AdminAccessSettings {
  ...
  return {
    ...
    allowGuestEditApiProvider: input.allowGuestEditApiProvider ?? DEFAULT_ADMIN_ACCESS.allowGuestEditApiProvider,
    allowGuestCreateCustomProvider: input.allowGuestCreateCustomProvider ?? DEFAULT_ADMIN_ACCESS.allowGuestCreateCustomProvider,
